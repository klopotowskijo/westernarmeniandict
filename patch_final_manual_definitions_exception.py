...
input_path = 'western_armenian_merged_with_english_final3.json'
output_path = 'western_armenian_merged_with_english_final4.json'
manual = {
...
for entry in data:
    ...
    if title in manual:
        ...
        entry['definition_en_translated_by'] = 'manual exception patch 4.22'
        count += 1

with open(output_path, 'w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

print(f'Patched {count} exception definitions. Output: {output_path}')
